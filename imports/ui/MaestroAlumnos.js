  ...
  render () {
    return (
        ...
        <div className="headerbar">    
          ...
          <nav className="navbar-custom">    
            <ul className="list-inline float-right mb-0">    
              <li className="list-inline-item dropdown notif">
                ...
                <div className="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-arrow-success dropdown-lg">
                  ...
                  <div className="dropdown-item noti-title">
                    ...
                    {/*En este apartado es para la ayuda*/}
                    {/*<!-- item-->*/}
                ...
                {/*Apartir de aqui es para los iconos de mensajes */}
              <li className="list-inline-item dropdown notif">
                <a className="nav-link dropdown-toggle arrow-none" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
              ...
              {/* Termina la lista de personas */}
    
                {/* Aqui inicia la lista para las notificaciones */}
              <li className="list-inline-item dropdown notif">
                <a className="nav-link dropdown-toggle arrow-none" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
              ...
              {/* Aqui termina la lista para las notificaciones */}
                {/* Aqui inicia para el profile imagenes */}
              <li className="list-inline-item dropdown notif">
            ...
            {/* Aqui termina la lista de profile imagen */}
            </ul>
      ...
      <div id="wrapper">
        ...
        {/*Lista de menu lateral izquierdo*/}
        ...
        {/*End Left Sidebar*/}
        {/*fin de la lista de menu lateral izquierdo*/}
        {/*Content*/}
